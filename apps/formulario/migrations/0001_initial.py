# Generated by Django 4.2.7 on 2024-05-25 17:35
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "historia_clinica",
                    models.BooleanField(
                        default=False, verbose_name="Diagnóstico histológico"
                    ),
                ),
                (
                    "motivo_de_consulta",
                    models.CharField(
                        choices=[
                            ("Aparición de lesión", "Aparición de lesión"),
                            ("Aumento de volumen", "Aumento de volumen"),
                            ("Nódulo cervical", "Nódulo cervical"),
                ...
                (
                    ...
                    models.PositiveIntegerField(verbose_name="Tamaño de la lesión"),
                ),
                (
                ...
                (
                    ...
                    models.PositiveIntegerField(verbose_name="Historia Clínica No"),
                ),
                (
                    "fecha_de_inscripcion",
                    models.DateTimeField(verbose_name="Fecha de inscripcion"),
                ),
                (
                    "creatinina",
                    models.DecimalField(
                ...
                (
                    ...
                    models.CharField(
                        max_length=256, verbose_name="Diagnóstico Morfológico"
                    ),
                ),
                (
                    "diagnostico_en",
                    models.CharField(max_length=256, verbose_name="Diagnóstico En"),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("E. clínico", "E. clínico"),
                            ("Inv. clínica", "Inv. clínica"),
                            ("Cirugía", "Cirugía"),
                            ("P. bio. Inmunológ", "P. bio. Inmunológ"),
                            ("Citología", "Citología"),
                ...
                ("otras", models.TextField(blank=True, null=True, verbose_name=" ")),
                (
                    "etapa_clinica",
                    models.CharField(
                        choices=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("Extensión directa", "Extensión directa"),
                            ("No aplicable", "No aplicable"),
                            ("Linfático regionales", "Linfático regionales"),
                        ],
                        max_length=256,
                ...
                ("tipo_de_cirugia", models.TextField(verbose_name="Tipo de cirugía")),
                (
                    "fecha_del_tratamiento_quirurgico",
                    models.DateTimeField(verbose_name="Fecha del tratamiento"),
                ),
                (
                ...
                (
                    "dosis_total",
                    models.DecimalField(
                        decimal_places=2, max_digits=15, verbose_name="Gosis totaD"
                    ),
                ),
                (
                    "gy_fraccion",
                    models.DecimalField(
                        decimal_places=2, max_digits=15, verbose_name="GY fracción"
                    ),
                ),
                (
                ...
                (
                    "esquema_tratamiento",
                    models.CharField(
                        max_length=256, verbose_name="Esquema del tratamiento"
                    ),
                ),
                (
                    "numero_de_ciclos",
                    models.PositiveIntegerField(verbose_name="No de ciclos"),
                ),
                (
                ...
                (
                    "cual_tratamiento",
                    models.CharField(max_length=256, verbose_name="Cuál tratamiento"),
                ),
                (
                    "fecha_del_inicio_del_tratamiento",
                    models.DateField(verbose_name="Fecha del inicio del tratamiento"),
                ),
                (
                    "fecha_del_final_del_tratamiento",
                    models.DateField(verbose_name="Fecha del final del tratamiento"),
                ),
                (
                ...
                ("fecha_evaluacion", models.DateField(verbose_name="Fecha")),
                ("observaciones", models.TextField(verbose_name="Observaciones")),
                (
                    "nombre_del_medico",
                    models.CharField(max_length=256, verbose_name="Médico"),
                ),
                (
                    "registro_profesional",
                    models.PositiveIntegerField(verbose_name="Registro profesional"),
                ),
                (
                    "firma_del_medico",
                    models.CharField(max_length=256, verbose_name="Firma"),
                ),
            ],
            options={
